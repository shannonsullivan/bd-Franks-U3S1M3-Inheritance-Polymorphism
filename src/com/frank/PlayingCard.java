...
// Abstract on a class means the class cannot be instantiated and is meant to always be a superclass
// They can be used to hold a reference to a subclass of its type (Polymorphism)
...
abstract class PlayingCard {
    ...
    //                             public       data-type - type of data returned by the method
    ...
    //
    // abstract on a method indicates this class does not know what the behavior should be for the method and
    // requires any subclass to implement the behavior of the method.
    //
    // "I don't know what this does, but I know you will have to have one if you inherit me"

    abstract void showCard(); // required for Polymorphism to work - even though it does nothing
